...
func TestComp(t *testing.T) {
	tests := []struct {
		...
		{CmpInfer, "int", "@"},
		{CmpConvAny, "int", "any"},
		{CmpConvList, "arr|int", "list"},
		{CmpConvList, "(obj +x +y int)", "list"},
		{CmpConvDict, "map|int", "dict"},
		{CmpConvDict, "(obj +x +y int)", "dict"},
		{CmpConvBase, "int", "num"},
		{CmpConvBase | BitUnwrap, "int?", "num"},
		{CmpConvSpec, "num", "int"},
		{CmpConvSpec | BitWrap, "num", "int?"},
